...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference('Playlist.count') do
      post playlists_url, params: { playlist: { name: @playlist.name, numOfSongs: @playlist.numOfSongs, user_id: @playlist.user_id } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { name: @playlist.name, numOfSongs: @playlist.numOfSongs, user_id: @playlist.user_id } }
